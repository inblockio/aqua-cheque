...
import { CHEQUE_ABI, CHEQUE_CONTRACT_ADDRESS } from "./chequeAbi.js";
...
async function bankCheque() {
    ...
    const contractAddress = CHEQUE_CONTRACT_ADDRESS; // Example contract address (often the first deployed contract in Hardhat)
    // const contractABI = [
